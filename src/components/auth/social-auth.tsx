...
/** Divider + federated sign-in. Wired to a toast until an auth provider exists. */
  ...
  return (
    <>
      ...
      <Button
        ...
        className="w-full"
        onClick={() =>
          toast.info("Google sign-in is not connected", {
            description: "Add an auth provider to enable this.",
          })
        }
      >
        <GoogleMark />
